...
cumul_mort_control_replicate_4 = df_control.Replicate4[1:40];
cumul_mort_control_replicate_5 = df_control.Replicate5[1:61];
cumul_mort_control_replicate_6 = df_control.Replicate6[1:37];

cumul_mort_treated_replicate_1 = df_treated.Replicate1[1:16];
cumul_mort_treated_replicate_2 = df_treated.Replicate2[1:25];
cumul_mort_treated_replicate_4 = df_treated.Replicate4[1:29];
cumul_mort_treated_replicate_5 = df_treated.Replicate5[1:24];
cumul_mort_treated_replicate_6 = df_treated.Replicate6[1:23];
...
plot!(ages_control[1:40], cumul_mort_control_replicate_4, line=3, c=:red);
plot!(ages_control[1:61], cumul_mort_control_replicate_5, line=3, c=:orange);
plot!(ages_control[1:37], cumul_mort_control_replicate_6, line=3, c=:purple);
...
plot!(ages_treated[1:29], cumul_mort_treated_replicate_4, line=3, c=:red);
plot!(ages_treated[1:24], cumul_mort_treated_replicate_5, line=3, c=:orange);
plot!(ages_treated[1:23], cumul_mort_treated_replicate_6, line=3, c=:purple);
...
scatter!(ages_control[1:40], cumul_mort_control_replicate_4 ./ 50, ms=5, c=:red, alpha=0.5);
scatter!(ages_control[1:61], cumul_mort_control_replicate_5 ./ 50, ms=5, c=:orange, alpha=0.5);
scatter!(ages_control[1:37], cumul_mort_control_replicate_6 ./ 50, ms=5, c=:purple, alpha=0.5);
...
scatter!(ages_treated[1:29], cumul_mort_treated_replicate_4 ./ 50, ms=5, c=:red, alpha=0.5);
scatter!(ages_treated[1:24], cumul_mort_treated_replicate_5 ./ 50, ms=5, c=:orange, alpha=0.5);
scatter!(ages_treated[1:23], cumul_mort_treated_replicate_6 ./ 50, ms=5, c=:purple, alpha=0.5);
...
plot!([], color=:red, line=3, label="Replicate 4");
plot!([], color=:orange, line=3, label="Replicate 5");
plot!([], color=:purple, line=3, label="Replicate 6");
...
scatter!([], color=:red, ms=5, label="Replicate 4");
scatter!([], color=:orange, ms=5, label="Replicate 5");
scatter!([], color=:purple, ms=5, label="Replicate 6");
...
feeding_control_replicate_4 = df_feeding_control.Replicate4[1:10];
feeding_control_replicate_5 = df_feeding_control.Replicate5[1:15];
feeding_control_replicate_6 = df_feeding_control.Replicate6[1:9];
...
feeding_treated_replicate_4 = df_feeding_treated.Replicate4[1:7];
feeding_treated_replicate_5 = df_feeding_treated.Replicate5[1:6];
feeding_treated_replicate_6 = df_feeding_treated.Replicate6[1:7];
...
plot!(ages_control[1:10], feeding_control_replicate_4, line=3, c=:red);
plot!(ages_control[1:15], feeding_control_replicate_5, line=3, c=:orange);
plot!(ages_control[1:9], feeding_control_replicate_6, line=3, c=:purple);
...
plot!(ages_treated[1:7], feeding_treated_replicate_4, line=3, c=:red);
plot!(ages_treated[1:6], feeding_treated_replicate_5, line=3, c=:orange);
plot!(ages_treated[1:7], feeding_treated_replicate_6, line=3, c=:purple);
